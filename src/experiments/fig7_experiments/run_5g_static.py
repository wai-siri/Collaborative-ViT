...
def main():
    parser = argparse.ArgumentParser(description='Run Fig. 7 5G Static experiment')
    ...
    print("="*80)
    print("Fig. 7 Experiment - 5G Static Scenario")
    print("="*80)
    ...
    for method in args.methods:
        ...
        try:
            ...
            output_path = f'results/fig7/5g_static_{method}.json'
    ...
    if all_results:
        save_summary(all_results, 'results/fig7/5g_static_summary.json')
    
    print("\n" + "="*80)
    print("✓ Experiment completed!")
    print("="*80)
    print("Results saved to:")
    print("  - results/fig7/5g_static_*.json")
    print("  - results/fig7/5g_static_summary.json")
    print("="*80)
