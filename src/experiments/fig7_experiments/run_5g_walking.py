...
def main():
    parser = argparse.ArgumentParser(description='Run Fig. 7 5G Walking experiment')
    ...
    print("="*80)
    print("Fig. 7 Experiment - 5G Walking Scenario")
    print("="*80)
    ...
    trace_df = load_trace('walking', '5g')
    print()
    ...
    for method in args.methods:
        ...
        try:
            ...
            output_path = f'results/fig7/5g_walking_{method}.json'
    ...
    if all_results:
        save_summary(all_results, 'results/fig7/5g_walking_summary.json')
    
    print("\n" + "="*80)
    print("✓ Experiment completed!")
    print("="*80)
    print("Results saved to:")
    print("  - results/fig7/5g_walking_*.json")
    print("  - results/fig7/5g_walking_summary.json")
    print("="*80)
