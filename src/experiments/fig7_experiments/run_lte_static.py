"""
Fig. 7实验 - LTE Static场景
这是第一个验证场景，用于测试整个实验流程
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run Fig. 7 LTE Static experiment')
    ...
    print("="*80)
    print("Fig. 7 Experiment - LTE Static Scenario")
    print("="*80)
    ...
    trace_df = load_trace('static', 'lte')
    print()
    ...
    for method in args.methods:
        ...
        try:
            ...
            # 保存单个方法的详细结果
            output_path = f'results/fig7/lte_static_{method}.json'
    ...
    # 保存汇总结果
    if all_results:
        save_summary(all_results, 'results/fig7/lte_static_summary.json')
    
    print("\n" + "="*80)
    print("✓ Experiment completed!")
    print("="*80)
    print("Results saved to:")
    print("  - results/fig7/lte_static_*.json")
    print("  - results/fig7/lte_static_summary.json")
    print("="*80)
